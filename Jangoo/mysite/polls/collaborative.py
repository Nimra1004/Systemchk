...
import pandas as pd
products = pd.read_csv("C:/Users/HP/Desktop/input/JokeText.csv")
data = pd.read_csv("C:/Users/HP/Desktop/input/UserRatings1.csv",index_col="productId")
data.head()
